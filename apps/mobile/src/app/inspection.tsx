  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.sub}>
        Aracın 4 yönünden fotoğraf çekilecek alan. Şimdilik fotoğraf yükleme mock olarak kaydediliyor.
      </Text>
...
const styles = StyleSheet.create({
  ...
  photo: { width: "47%", height: 130, backgroundColor: "white", borderRadius: 20, alignItems: "center", justifyContent: "center", borderWidth: 1, borderColor: colors.border },
